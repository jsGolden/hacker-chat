...
export default class Controller {
    ...
    async joinRoom(socketId, data) {
        ...
        // Atualiza o usuario que conectou à uma sala
        // sobre quais usuário ja estão conectados na mesma sala
        ...
        // Avisa à todos os sockets que um novo usuário se conectou
        this.broadCast({
            socketId,
            roomId,
    ...
    #onSocketClosed(id) {
        return _ => {
            ...
            console.log(userName, 'has been disconnected', id);
